...
const Dashboard: FC = () => {
  ...
  return (
    <div className={styles.dashboard}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.topSection}>
          <QuickActions
            ...
            onReportClick={() => setShowReportsModal(true)}
          />
      ...
      <ReportsModal open={showReportsModal} onClose={() => setShowReportsModal(false)} />
    </div>
  );
};
